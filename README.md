...
This python package creates a 'Counter Attack: The Football Strategy Game' player card data file for any real-life player(s) with 'Football Manager' data from [FMInside](https://fminside.net/). 
